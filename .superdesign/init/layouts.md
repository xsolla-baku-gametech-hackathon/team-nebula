...
Root application shell with a compact product header and scrollable content area.
...
There are no nested layouts, sidebar components, or shared footer components.
